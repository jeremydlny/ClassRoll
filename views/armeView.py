...
class ArmeView(discord.ui.View):
    ...
    @discord.ui.button(label='🔄 AUTRE ARME', style=discord.ButtonStyle.primary, row=0)
    ...
    @discord.ui.button(label='🗡️ SECONDAIRE', style=discord.ButtonStyle.success, row=0)
